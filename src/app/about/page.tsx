...
const CONTENT: Record<Lang, {
  ...
  en: {
    ...
    brands: [
      { name: 'Class Media', desc: "Albania's leading media house - home to Inspire Podcast, Revista Class and Meet the Founder." },
      { name: 'Class Events', desc: 'Corporate event organization and decoration.' },
      { name: 'Class by AV & Shop Class', desc: 'Bridal dresses and premium linen.' },
      { name: 'Class Beauty House', desc: 'Beauty and styling house.' },
      { name: 'Grow and Inspire', desc: 'Platform for personal and business growth.' },
    ],
  ...
  sq: {
    ...
    brands: [
      { name: 'Class Media', desc: 'Shtëpia mediatike kryesore në Shqipëri - shtëpia e Inspire Podcast, Revista Class dhe Meet the Founder.' },
      { name: 'Class Events', desc: 'Organizim dhe dekorim eventesh korporative.' },
      { name: 'Class by AV & Shop Class', desc: 'Fustane nuserie dhe lino premium.' },
      { name: 'Class Beauty House', desc: 'Shtëpi bukurie dhe stilimi.' },
      { name: 'Grow and Inspire', desc: 'Platformë për zhvillim personal dhe biznesi.' },
    ],
